...
var Synchronizer = /** @class */ (function () {
    ...
    Synchronizer.prototype.getLock = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.lockPromises.push(new Promise(function (resolve) { return _this.resolvers.push(resolve); }));
                        if (this.lockPromises.length === 1) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.lockPromises[this.lockPromises.length - 2]];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Synchronizer.prototype.releaseLock = function () {
        if (this.lockPromises.length > 0) {
            this.lockPromises.shift();
            var resolver = this.resolvers.shift();
            resolver();
            return;
        }
    };
