...
var logger = js_sdk_logging_1.getLogger('NodeDatafileManager');
var NodeDatafileManager = /** @class */ (function (_super) {
    ...
    function NodeDatafileManager(config) {
        ...
        _this = _super.call(this, __assign({}, config, { urlTemplate: config.urlTemplate || defaultUrlTemplate })) || this;
